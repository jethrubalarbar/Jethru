...
//import tooltwist.jethru.productionHelpers.SocialmediaProductionHelper;
 ...
 * Social Media
 */
public class SocialmediaWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "socialmedia_preview.html";
	private static final String SNIPPET_DESIGN = "socialmedia_design.html";
	private static final String SNIPPET_PRODUCTION = "socialmedia_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "socialmedia_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "socialmedia_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, SocialmediaProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(SocialmediaProductionHelper.class.getName()));
			}
		}
