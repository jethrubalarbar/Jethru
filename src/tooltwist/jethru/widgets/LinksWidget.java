...
//import tooltwist.jethru.productionHelpers.LinksProductionHelper;
 ...
 * links
 */
public class LinksWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "links_preview.html";
	private static final String SNIPPET_DESIGN = "links_design.html";
	private static final String SNIPPET_PRODUCTION = "links_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "links_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "links_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, LinksProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(LinksProductionHelper.class.getName()));
			}
		}
