...
import tooltwist.jethru.productionHelpers.StudentListProductionHelper;
 ...
 * Student List Widget
 */
public class StudentListWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "studentList_preview.html";
	private static final String SNIPPET_DESIGN = "studentList_design.html";
	private static final String SNIPPET_PRODUCTION = "studentList_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "studentList_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "studentList_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, StudentListProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(StudentListProductionHelper.class.getName()));
			}
		}
