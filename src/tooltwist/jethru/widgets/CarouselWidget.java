...
//import tooltwist.jethru.productionHelpers.CarouselProductionHelper;
 ...
 * Carousel Widget
 */
public class CarouselWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "carousel_preview.html";
	private static final String SNIPPET_DESIGN = "carousel_design.html";
	private static final String SNIPPET_PRODUCTION = "carousel_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "carousel_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "carousel_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, CarouselProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(CarouselProductionHelper.class.getName()));
			}
		}
