...
public class GoogleWidget extends WbdWidgetController
{
	...
	protected void init(WbdWidget instance) throws WbdException
	{
		...
		instance.defineProperty(new WbdStringProperty("xcoor", null, "X-Coordinate", "51.508742"));
		instance.defineProperty(new WbdStringProperty("ycoor", null, "Y-Coordinate", "0.120850"));
...
//				codeInserterList.add(new PageImportCodeInserter(GoogleProductionHelper.class.getName()));
	...
	private SnippetParam[] getSnippetParams(WbdGenerator generator, WbdWidget instance, UimData ud) throws WbdException {
		...
		String xcoor = instance.getProperty("xcoor", null);
		String ycoor = instance.getProperty("ycoor", null);
//		String myNavpoint = instance.getProperty("myNavpoint", null);
		SnippetParam[] params = {
			...
			new SnippetParam("xcoor", xcoor),
			new SnippetParam("ycoor", ycoor)
